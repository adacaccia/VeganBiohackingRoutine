...
**Stato produzione:** 🟡 In lavorazione
...
🎙️ **Script voce / doppiaggio**  
→ [EP01-colazione_script_voce.md](01-script/EP01-colazione_script_voce.md)

🌍 **Versione inglese**  
→ [EP01-breakfast_EN.md](01-script/EP01-breakfast_EN.md)

🔤 **Pronuncia (EN)**  
→ [EP01-breakfast_pronunciation.md](01-script/EP01-breakfast_pronunciation.md)

🎧 **Checklist voce inglese**  
...
🎬 **Storyboard intro**  
→ [EP01-colazione_storyboard_intro.md](02-storyboard/EP01-colazione_storyboard_intro.md)
...
- Inquadrature stabili, ritmo lento  
...
🎚️ **Checklist montaggio**  
→ [EP01-colazione_checklist_montaggio.md](04-montaggio/EP01-colazione_checklist_montaggio.md)

🎙️ **Doppiaggio in Kdenlive (setup)**  
...
🪪 **Metadata YouTube**  
→ [meta_EP01_title_description_tags.md](05-pubblicazione/meta_EP01_title_description_tags.md)
...
📚 **Template e system files (se utili)**  
...
- Varianti della colazione (inverno / estate)  
- Versione 60 sec per Shorts  
